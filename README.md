...
<ul>
  <li><a href="Images/UI_Web_Interface.png" target="_blank">➡️ View Web UI Interface</a></li>
  <li><a href="Images/data_flow.png" target="_blank">➡️ View Block Diagram of Data Flow</a></li>
